...
const getMetadata = async (_req, res, next) => {
    try {
        ...
        (0, response_1.sendSuccess)(res, metadata);
    }
    catch (err) {
        next(err);
    }
...
const updateMetadata = async (req, res, next) => {
    try {
        ...
        (0, response_1.sendSuccess)(res, updated, 'Metadata updated successfully');
    }
    catch (err) {
        next(err);
    }
